...
jornadas grandes de cambios quedan registradas en `workflow_*.md` (ultima:
`workflow_2026-06-13_grafico_carrera_de_puntaje.md` = GRAFICO + orden fixture en
PARTIDOS + limpieza coral; anterior `workflow_2026-06-12_modo_competencia_oficial.md`).
