-- ============================================================================
-- APLICAR EN SUPABASE: funciones de acceso temporal de edicion de predicciones
-- ============================================================================
-- Proyecto: vsyamgdslgeinbxwofnu (Polla Mundialera SECPLAN 2026)
--
-- POR QUE: la migracion 20260609193000_prediction_edit_access.sql nunca se
-- aplico al proyecto remoto. Por eso /admin muestra el error:
--   "Could not find the function public.polla_list_prediction_edit_access(p_token)"
--
...
-- Depende de: public.polla_assert_admin y pgcrypto, ya instalados por la
-- migracion 20260608170000_polla_live_realtime.sql (aplicada y funcionando).
-- ============================================================================
...
-- Recargar el schema cache de PostgREST para exponer las RPC de inmediato.
